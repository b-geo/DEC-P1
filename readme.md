...
- **Make sure you're committing to the correct branch**. More than once I had no switched branches to the one I wanted to be working on. In addition to that, I forgot to pull before making changes to a branch.
